...
public class CommentEditActivity_bak extends BaseActivity {
    ...
    public void initWidget() {
        ...
        setContentView(R.layout.layout_activity_comments_list_edit_bak);
        //
        //scoreAOP = initAOP();
        scoreData = initData();
        //scoreMark = initMark();
        ...
        tvScore = findViewById(R.id.tv_com_score);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if(ev.getAction()==MotionEvent.ACTION_DOWN){
            ...
            if(hideInputResult){
                ...
                InputMethodManager imm = (InputMethodManager) CommentEditActivity_bak.this
