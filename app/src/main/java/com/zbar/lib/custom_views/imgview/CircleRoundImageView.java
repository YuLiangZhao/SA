...
public class CircleRoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderThickness = a.getDimensionPixelSize(
                R.styleable.CircleRoundImageView_borderThickness, 0);
        mBorderOutsideColor = a
                .getColor(R.styleable.CircleRoundImageView_borderOutColor,
                        defaultColor);
        mBorderInsideColor = a.getColor(
                R.styleable.CircleRoundImageView_borderInColor, defaultColor);
    }
