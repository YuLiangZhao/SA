...
public class oImageView extends ImageView {
    ...
    public oImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        // R.styleable.oImageView, defStyle, 0);
        //
        // mBorderWidth =
        // a.getDimensionPixelSize(R.styleable.oImageView_border_width,
        // DEFAULT_BORDER_WIDTH);
        // mBorderColor = a.getColor(R.styleable.oImageView_border_color,
