package com.zbar.lib.app_update;
...
import com.zbar.lib.BaseApplication;
import com.zbar.lib.BuildConfig;
...
public class AutoUpdateManager implements DialogInterface.OnClickListener, Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            //保存到的文件夹
            File file = new File(BaseApplication.SAVE_PATH + "/Apk/");
            if (!file.exists()) {
                file.mkdir();
            }
