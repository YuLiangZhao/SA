...
import com.zbar.lib.test.pickerview_test.PickerTestActivity;
...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        Menu_Grid =(AliPayGridView) view.findViewById(R.id.gv_btn1_menu_grid);//教师菜单九宫格
    ...
    public void GridItemClick(int position) {
        switch (position) {
            ...
            case 1:
                ...
                //跳转界面
                startActivity(new Intent(getActivity(), ShowStudentClassWorkPic.class));
                break;
            case 2:
